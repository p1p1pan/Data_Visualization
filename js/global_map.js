document.addEventListener('DOMContentLoaded', async () => {
    ...
    function populateMapControls() {
        ...
        initializeSlider(mapHigherEdRateMinInput, mapHigherEdRateMaxInput, '高等教育入学率', true, 0, 100);
    ...
    function updateGlobalMap() {
        ...
        const filters = {
            ...
            '高等教育入学率': [Number(mapHigherEdRateMinInput?.value), Number(mapHigherEdRateMaxInput?.value)]
        };
